...
import { Container, Card, Button, ListGroup, Row, Col, Badge, Spinner } from 'react-bootstrap';
    ...
    <Container className="py-4">
      ...
      <Card className="border-0 shadow-lg overflow-hidden" style={{ 
        ...
        <div className="position-relative">
          <div style={{
            height: '1200px', // Aumentado de 300px a 600px
                ...
                <Card.Body>
                  <ListGroup variant="flush">
                    <ListGroup.Item className="border-0 px-0">
                      <strong>Full Name:</strong> {hero.biography['full-name'] || 'Unknown'}
                    </ListGroup.Item>
                    <ListGroup.Item className="border-0 px-0">
